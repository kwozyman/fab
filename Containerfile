...
RUN dnf install -y make git python3-pip python3-pytest black python3-flake8 python3-mypy python3-autopep8 python3-kickstart python3-build python3-setuptools python3-yaml
ADD . /src
